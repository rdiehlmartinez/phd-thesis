...
\begin{quote}
    \textbf{Research Question 2: How can we more quantitatively understand how small models learn and how can we use this understanding to improve model design and training?}
\end{quote}
