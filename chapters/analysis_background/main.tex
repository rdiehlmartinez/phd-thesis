...
While convergence analysis provides a high-level view of how internal representations stabilize over time, another important dimension of learning dynamics is how models manage and allocate their \thesishl{capacity}: that is, the number of different complex `functions' or more broadly patterns a model can learn. Analyses of \thesishl{sparsity} and \thesishl{norms} offer fine-grained insight into how models compress information over the training process.
