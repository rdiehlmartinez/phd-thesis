...
\begin{enumerate}
    \item \colorbox{orange!10}{\textbf{Sequential learning} (Seq)} We first train the model to predict word classes, then transition to the full MLM objective. This approach mirrors the developmental progression observed in children, where they first learn to distinguish between major word classes before mastering specific lexical items.
    
    \item \colorbox{orange!30}{\textbf{Multi-task learning} (MT)} We train the model to simultaneously predict both word classes and specific tokens, with separate task heads and optimizers for each objective. This approach allows the model to benefit from both coarse-grained and fine-grained learning signals throughout training.
\end{enumerate}
...
\begin{table*}
    ...
    \midrule
    \rowcolor{green!10}\textsuperscript{\textdagger}Linear & Freq & 9.70 & 75.09 & \textbf{66.43} & 68.71 & 68.61 \\
    \rowcolor{green!30}Linear & POS & 10.17 & 72.06 & 63.44 & 69.50 & 66.91 \\
    \rowcolor{green!50}Linear & Hybrid & 10.21 & 73.37 & 66.11 & 69.22 & 66.61 \\
    \rowcolor{green!10}Log & Freq & 9.26 & 74.97 & 64.63 & 69.94 & 66.82 \\
    \rowcolor{green!30}Log & POS & 9.29 & 74.12 & 62.06 & \textbf{70.66} & \textbf{70.52} \\
    \rowcolor{green!50}Log & Hybrid & 9.29 & 74.74 & 63.62 & 70.29 & 66.42 \\
    \midrule
...
%    \setlength{\tabcolsep}{3pt}  % Reduce column spacing further
    ...
    Pacing & Type & PPX & BLiMP & BLiMP.S & GLUE & MSGS \\
    \midrule
    \rowcolor{purple!10} Linear & Source & 10.41 & 73.32 & 61.99 & 69.68 & 66.22 \\
    \rowcolor{purple!30} Linear & Static PPL & 12.51 & 72.45 & 61.67 & 69.10 & 66.90 \\
    \rowcolor{purple!50} Linear & Dynamic PPL-U & 11.88 & 72.62 & 62.57 & 69.86 & 66.64 \\
    \rowcolor{purple!50} Linear & Dynamics PPL-R & 10.82 & 71.88 & 63.10 & 70.37 & 67.48 \\
    \rowcolor{purple!10}\textsuperscript{\textdagger}Log & Source & \textbf{9.21} & \textbf{75.87} & 64.29 & 70.20 & \textbf{70.99} \\
    \rowcolor{purple!30} Log & Static & 9.39 & 75.03 & 63.78 & 69.90 & 66.69 \\
    \rowcolor{purple!50} Log & Dynamic PPL-U & 9.35 & 74.83 & 64.24 & 70.09 & 66.89 \\
    \rowcolor{purple!50} Log & Dynamic PPL-R & \textbf{9.21} & 75.81 & 63.03 & 68.93 & 66.64 \\
    \midrule
...
\begin{table*}
    ...
    Type & 3 POS & 10 POS & MLM & PPX & BLiMP & BLiMP.S & GLUE & MSGS \\
    \midrule
    \rowcolor{orange!10}  Seq & 0 - 12.5  & 12.5 - 100 & 9.58  & 73.87 & 62.98      & 69.85       & 66.70    \\
    \rowcolor{orange!25}  MT & 0 - 100     & 12.5 - 100 & 9.78   & 74.60 & 62.17     & 69.12       & 66.64    \\
    \rowcolor{orange!25}  MT & 0 - 100     & 0 - 100    & 9.30  & \textbf{75.82} & 65.77     & \textbf{70.74}       & 66.58    \\
    \rowcolor{orange!10}  Seq & 0 - 6.25 & 6.25 - 12.5 & 12.5 - 100 & 9.49  & 74.03 & 63.02      & 70.71       & 66.93    \\
    \rowcolor{orange!25}  MT & 0 - 6.25 & 6.25 - 100  & 12.5 - 100 & 9.72  & 73.68 & 63.89     & 70.07       & 67.00    \\
    \rowcolor{orange!25} \textsuperscript{\textdagger}  MT & 0 - 6.25 & 6.25 - 100  & 0 - 100    &  9.30 & 74.80 & \textbf{67.55}      & 69.89       & 67.65    \\
    \rowcolor{orange!25}  MT & 0 - 100  & 0 - 100   & 9.25  & 74.48 & 63.98     & 69.77       & 67.72    \\
    \midrule
