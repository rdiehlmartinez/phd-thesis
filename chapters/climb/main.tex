...
\begin{table*}[h!]
    ...
    Log & \lightpurplehighlight{Source} & $\mathbf{\posval{+0.4 \pm 2.0}}$ & $\negval{-1.1 \pm 3.7}$ & $\negval{-0.3 \pm 1.0}$ & $\mathbf{\posval{+2.7 \pm 8.4}}$ \\
    Log & \darkpurplehighlight{Static PPX} & $\negval{-0.5 \pm 1.3}$ & $\negval{-1.6 \pm 1.8}$ & $\negval{-0.6 \pm 1.4}$ & $\negval{-1.6 \pm 2.8}$ \\
    Log & \verydarkpurplehighlight{Dynamic PPX-U} & $\negval{-0.7 \pm 2.2}$ & $\negval{-1.1 \pm 2.7}$ & $\negval{-0.4 \pm 1.9}$ & $\negval{-1.4 \pm 3.0}$ \\
    Log & \verydarkpurplehighlight{Dynamic PPX-R} & $\posval{+0.3 \pm 1.0}$ & $\negval{-2.3 \pm 3.1}$ & $\negval{-1.5 \pm 5.0}$ & $\negval{-1.7 \pm 2.3}$ \\
    \midrule
    \multicolumn{2}{l|}{Vanilla Baseline} & 75.48 & 65.34 & 70.47 & 68.30 \\
    \bottomrule
    \end{tabular}
    \caption{\label{tbl:result-data-cl} Results for data curriculum models (\cref{subsec:data-cl}), reported as mean relative difference ($\pm$ std) from the vanilla baseline across subtasks. \posval{Green} indicates improvement; \negval{red} indicates decrease. All models score above 92 in the MSGS Control tasks. BLiMP.S = BLiMP.Supp, GLUE = (Super)GLUE, MSGS = MSGS Ambig.}
\end{table*}
...
\begin{table*}[h!]
    ...
    -- & \verydarkpurplehighlight{Dyn. PPX-R} & \darkorangehighlight{MT} & $\posval{+0.4 \pm 1.8}$ & $\negval{-0.7 \pm 1.1}$ & $\negval{-0.8 \pm 2.5}$ & $\negval{-0.5 \pm 1.9}$ \\
    \lightgreenhighlight{Freq} & \lightpurplehighlight{Source} & -- & $\posval{+0.4 \pm 2.0}$ & $\negval{-0.7 \pm 3.0}$ & $\negval{-0.2 \pm 2.5}$ & $\negval{-0.4 \pm 2.9}$ \\
    \lightgreenhighlight{Freq} & \verydarkpurplehighlight{Dyn. PPX-R} & -- & $\posval{+0.4 \pm 2.0}$ & $\mathbf{\posval{+0.5 \pm 2.8}}$ & $\negval{-0.0 \pm 2.5}$ & $\negval{-1.7 \pm 4.2}$ \\
    \lightgreenhighlight{Freq} & \lightpurplehighlight{Source} & \darkorangehighlight{MT} & $\negval{-0.6 \pm 2.0}$ & $\negval{-2.5 \pm 4.9}$ & $\negval{-0.4 \pm 2.0}$ & $\negval{-1.6 \pm 4.0}$ \\
    \lightgreenhighlight{Freq} & \verydarkpurplehighlight{Dyn. PPX-R} & \darkorangehighlight{MT} & $\mathbf{\posval{+0.4 \pm 1.2}}$ & $\negval{-1.7 \pm 4.2}$ & $\negval{-0.5 \pm 2.0}$ & $\mathbf{\posval{+3.0 \pm 7.3}}$ \\
    \midrule
    \multicolumn{3}{l|}{Vanilla Baseline} & 75.48 & 65.34 & 70.47 & 68.30 \\
    \bottomrule
    \end{tabular}
    \caption{\label{tbl:result-combination-cl} Results for the combination curriculum models, reported as mean relative difference ($\pm$ std) from the vanilla baseline across subtasks. \posval{Green} indicates improvement; \negval{red} indicates decrease. The multitask objective curriculum refers to the 2-task 10-POS and MLM model shown in \cref{tbl:result-obj-cl}. }
\end{table*}
